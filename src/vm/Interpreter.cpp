  ...
  while (cursor.hasNext()) {
    ...
    switch (opcode) {
      ...
      case Opcode::ICONST_2:
        frame.pushOperand(Value::Int(2));
        break;
      case Opcode::ICONST_3:
        frame.pushOperand(Value::Int(3));
        break;
      case Opcode::ICONST_4:
        frame.pushOperand(Value::Int(4));
        break;
      case Opcode::ICONST_5:
        frame.pushOperand(Value::Int(5));
        break;
      ...
      case Opcode::LDC2_W:
        ...
        break;
      case Opcode::ILOAD:
        frame.pushOperand(frame.loadValue(cursor.readU1()));
        break;
      case Opcode::LLOAD:
        notImplemented(opcode);
        break;
      ...
      case Opcode::ALOAD:
        ...
        break;
      case Opcode::ILOAD_0:
        frame.pushOperand(frame.loadValue(0));
        break;
      case Opcode::ILOAD_1:
        frame.pushOperand(frame.loadValue(1));
        break;
      case Opcode::ILOAD_2:
        frame.pushOperand(frame.loadValue(2));
        break;
      case Opcode::ILOAD_3:
        frame.pushOperand(frame.loadValue(3));
        break;
      case Opcode::LLOAD_0:
        notImplemented(opcode);
        break;
      ...
      case Opcode::ISTORE_1:
        frame.storeValue(1, frame.popInt());
        break;
      case Opcode::ISTORE_2:
        frame.storeValue(2, frame.popInt());
        break;
      case Opcode::ISTORE_3:
        frame.storeValue(3, frame.popInt());
        break;
