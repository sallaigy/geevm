...
// RUN: %compile -d %t -f "-Xjit org/geevm/tests/basic/LongXor#calculateXor(JJ)J" "%s" 2>&1 | FileCheck "%s"
package org.geevm.tests.basic;

import org.geevm.util.Printer;

public class LongXor {
    ...
    public static long calculateXor(long x, long y) {
        return x ^ y;
    }
